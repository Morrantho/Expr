...
#define X_DENO_PRES( TK, PREC, ASSOC, PREFIX, INFIX, POSTFIX ) [ PARSEPOS_PRE ][ TK_##TK ]  = DENO_##PREFIX,
#define X_DENO_INFS( TK, PREC, ASSOC, PREFIX, INFIX, POSTFIX ) [ PARSEPOS_INF ][ TK_##TK ]  = DENO_##INFIX,
#define X_DENO_POSTS( TK, PREC, ASSOC, PREFIX, INFIX, POSTFIX ) [ PARSEPOS_POST ][ TK_##TK ] = DENO_##POSTFIX,
